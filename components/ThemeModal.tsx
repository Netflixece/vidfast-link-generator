    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center p-4 z-50 animate-fade-in-fast" onClick={onClose}>
            ...
            >
                ...
                <div className="w-11/12 mx-auto h-px bg-neutral-700/50 flex-shrink-0"></div>
                ...
                {/* Custom Color Search */}
                <div className="px-6 pt-6 pb-4 flex-grow flex flex-col min-h-0">
                    <h3 className="text-xl font-semibold text-white mb-3 text-center flex-shrink-0">Custom Color</h3>
                    <input
                        type="text"
                        value={searchQuery}
